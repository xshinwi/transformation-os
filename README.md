...
**الترخيص**
- راجع ملف `LICENSE` فالمستودع (إذا موجود).

---

إذا بغيتي نزيد أمثلة عملية (screenshots، flow التسجيل بFirebase، أو شرح بنية Firestore) نقترح نضيفهم فالإصدار القادم من README.
